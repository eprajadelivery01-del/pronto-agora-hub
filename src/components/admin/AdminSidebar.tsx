...
import {
  LayoutDashboard, Truck, Map, Building2, ShoppingBag,
...
const navItems = [
  ...
  { label: "Entregadores", icon: (props: any) => <BikeIcon {...props} />, href: "/admin/drivers" },
  { label: "Clientes", icon: User, href: "/admin/customers" },
